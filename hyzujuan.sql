/*
 ...
 Source Server         : 192.168.5.235
 Source Server Type    : MySQL
 Source Server Version : 50710
 Source Host           : 192.168.5.235:3306
...
CREATE TABLE `tb_jiansuo`  (
  ...
  `point_id` int(11) DEFAULT NULL COMMENT '一级知识点ID',
  PRIMARY KEY (`jiansuo_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '一级知识点检索表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '日志追踪表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '长字符串存储表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `tb_permission`  (
  ...
  `permissionName` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '权限名',
  `url` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '资源路径',
...
CREATE TABLE `tb_role`  (
  ...
  `roleName` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '角色名',
  `roleDesc` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '角色描述',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '试卷表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `tb_shiti`  (
  ...
  `years` year DEFAULT NULL COMMENT '年份',
...
CREATE TABLE `tb_st_zsd`  (
  ...
  `status_review` tinyint(1) DEFAULT 1 COMMENT '状态1 2 3 三审机制',
  PRIMARY KEY (`point_id`, `shiti_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '试题知识点关系表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `tb_tijuan`  (
  ...
  `ques_number` int(11) DEFAULT 0 COMMENT '题号',
...
-- ----------------------------
-- Table structure for tb_use
-- ----------------------------
DROP TABLE IF EXISTS `tb_use`;
CREATE TABLE `tb_use`  (
  `shiti_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '试题ID',
  `que_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '题型 选择判断',
  `sub_class` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '题类 模拟 高考 期末',
  `difficult` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '难度 普通 中等 困难',
  `city` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '城市',
  `source` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '试题来源',
  `problem` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '题目 如果超过存知识点表中指针',
  `answer` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '答案 如果超过存知识点表中指针',
  `analysis` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '解析 如果超过存知识点表中指针',
  PRIMARY KEY (`shiti_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '试题表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `tb_user`  (
  ...
  `birthday` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '生日',
  ...
  `permission` tinyint(1) NOT NULL DEFAULT 0 COMMENT '用户权限 0,1,2学生,教师,管理',
...
CREATE TABLE `tb_zhishidian`  (
  ...
  `status_result` tinyint(1) DEFAULT 0 COMMENT '类别状态 1-已通过审核,0-未通过审核',
  PRIMARY KEY (`point_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '知识点表' ROW_FORMAT = Dynamic;
